...
func AuthReadMiddleware(userRepo portsrepo.User, logger *zap.Logger) gin.HandlerFunc {
	return func(c *gin.Context) {
		userExternalID := c.GetHeader(UserIDHeader)
...
func AuthReadWriteMiddleware(userRepo portsrepo.User, logger *zap.Logger) gin.HandlerFunc {
	return func(c *gin.Context) {
		userExternalID := c.GetHeader(UserIDHeader)
